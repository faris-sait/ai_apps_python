...
# Commented out to avoid CUDA_HOME requirement - using CPU fallback
...
def upfirdn2d(input, kernel, up=1, down=1, pad=(0, 0), device='cpu'):
    if upfirdn2d_op is not None and platform.system() == 'Linux' and torch.cuda.is_available() and device != 'cpu':
        out = UpFirDn2d.apply(
